...
const ES = Object.freeze({
  ...
  "Pay in person after final weighing": "Paga en persona después del pesaje final",
  "Final total is based on actual weight. Pay in person after your order is weighed; no card is collected online.": "El total final se basa en el peso real. Paga en persona después de que se pese tu pedido; no se recopila ninguna tarjeta en línea.",
  "Updates": "Avisos",
  ...
  "Submitting reserves route capacity. Final total is based on actual weight; pay in person after weighing. No card is collected online.": "Al enviar reservas capacidad en la ruta. El total final se basa en el peso real; paga en persona después del pesaje. No se recopila ninguna tarjeta en línea.",

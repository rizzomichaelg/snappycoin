...
const ES = Object.freeze({
  ...
  "Cloudflare hosts the API and operational database. Stripe handles card setup and payment. Twilio handles verification and operational texts. Resend handles transactional email. The selected geocoder must permit the intended retained-data use.": "Cloudflare aloja la API y la base operativa. Stripe gestiona la configuración de tarjeta y el pago. Twilio gestiona la verificación y mensajes operativos. Resend gestiona correos operativos. El geocodificador seleccionado debe permitir el uso previsto de los datos conservados.",

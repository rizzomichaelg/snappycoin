...
const ES = Object.freeze({
  ...
  "Book a laundry pickup": "Programa una recogida de ropa",
  "Loading secure card fields…": "Cargando los campos seguros de la tarjeta…",
  "Retry card setup": "Reintentar la configuración de la tarjeta",
  "Choose an available delivery window for this pickup.": "Elige un horario de entrega disponible para esta recogida.",
  "Card fields could not load. Try again without restarting your booking.": "No se pudieron cargar los campos de la tarjeta. Inténtalo de nuevo sin reiniciar tu reserva.",
  "Phone verification expired. Continue from your details to request a new code.": "La verificación del teléfono venció. Continúa desde tus datos para solicitar un código nuevo.",
  "Continue to review": "Continuar a la revisión",
  "Continuing…": "Continuando…",
  "Verifying…": "Verificando…",
  "Booking pickup…": "Reservando la recogida…",
  "Loading your order…": "Cargando tu pedido…",
  "Phone verified. You can now manage this order.": "Teléfono verificado. Ya puedes administrar este pedido.",
  "Pickup window · Central Time": "Horario de recogida · Hora Central",
  "Delivered · Central Time": "Entregado · Hora Central",
  // Compact order tracker.
  "Pickup, delivery, and payment updates in one place.": "Actualizaciones de recogida, entrega y pago en un solo lugar.",
  ...
  "Continue": "Continuar",
  "You’ll review the amount before paying. Paid tips are final.": "Revisarás el monto antes de pagar. Las propinas pagadas son definitivas.",
  "Order details & progress": "Detalles y progreso del pedido",
  "Order total": "Total del pedido",
  "All times are Central Time.": "Todos los horarios están en Hora Central.",
  "Manage order & account": "Administrar pedido y cuenta",
  "Changes, saved preferences, and order history": "Cambios, preferencias guardadas e historial de pedidos",
  "Verify to continue": "Verifica para continuar",
  "To protect your saved card and account, we’ll text a code to the mobile number on this order. Tracking and viewing your receipt do not require a code.": "Para proteger tu tarjeta guardada y tu cuenta, enviaremos un código por mensaje de texto al número móvil de este pedido. No necesitas un código para ver el estado ni el recibo.",
  "Only share this link with someone you trust. Need help?": "Comparte este enlace solo con alguien de confianza. ¿Necesitas ayuda?",
  "Verify your phone to use the saved card. Then review your tip before paying.": "Verifica tu teléfono para usar la tarjeta guardada. Después revisa la propina antes de pagar.",
  "Thank you for your tip": "Gracias por tu propina",
  "Enter the code we sent to your phone.": "Ingresa el código que enviamos a tu teléfono.",
  "We’ll only use this code to confirm it’s you.": "Solo usaremos este código para confirmar tu identidad.",
  "You’re verified": "Tu identidad está verificada",
  "Verified for this visit": "Verificado para esta visita",
  "Verified until {value}.": "Verificado hasta {value}.",
  ...
  "Expected bags": "Bolsas previstas",
  ...
  "Payment": "Pago",
  "Pickup": "Recogida",
  "About how many bags should we expect?": "¿Aproximadamente cuántas bolsas debemos esperar?",
  "Your best estimate helps us plan space and staffing. It does not affect your price.": "Tu mejor estimación nos ayuda a planificar el espacio y el personal. No afecta tu precio.",
  "Delivery": "Entrega",
  ...
  "$1.50/lb · $15 minimum. Final total is based on actual weight after pickup.": "$1.50/lb · mínimo de $15. El total final se calcula según el peso real después de la recogida.",
  ...
  "Optional thank-you": "Agradecimiento opcional",
  "Tips are optional once your order is out for delivery. No amount is selected for you.": "Las propinas son opcionales cuando tu pedido sale para entrega. No seleccionamos ningún monto por ti.",
  "1 bag expected · confirmed at pickup": "1 bolsa prevista · se confirma al recoger",
  "2 bags expected · confirmed at pickup": "2 bolsas previstas · se confirman al recoger",
  "1 bag expected": "1 bolsa prevista",
  "2 bags expected": "2 bolsas previstas",
  "A paid tip is final and cannot be changed or canceled online. Contact support if a payment was made in error.": "Una propina pagada es definitiva y no se puede cambiar ni cancelar en línea. Comunícate con soporte si se realizó un pago por error.",
  ...
  "Effective September 1, 2026": "Vigente desde el 1 de septiembre de 2026",
  ...
  "and": "y",
  "Marketing email consent is optional. We do not send marketing or promotional text messages. Transactional messages are used to perform requested service. Contact Snappy Coin Laundry at snappycoinlaundry@gmail.com or (314) 628-1001 to request access, correction, or deletion subject to operational and legal retention needs.": "El consentimiento para mercadeo por correo es opcional. No enviamos mensajes de texto de mercadeo ni promocionales. Los mensajes operativos se usan para prestar el servicio solicitado. Comunícate con Snappy Coin Laundry en snappycoinlaundry@gmail.com o al (314) 628-1001 para solicitar acceso, corrección o eliminación, sujeto a necesidades operativas y legales de conservación.",
  ...
  "The booking flow reserves the selected pickup and delivery windows after address and phone checks. Laundry is weighed after pickup and charged at $1.50 per pound with a $15 minimum.": "El proceso reserva los horarios seleccionados de recogida y entrega después de verificar la dirección y el teléfono. La ropa se pesa después de la recogida y se cobra a $1.50 por libra, con un mínimo de $15.",
  ...
  "Service providers": "Proveedores de servicios",
  "Your choices": "Tus opciones",
  "Reply STOP to any Snappy text message to stop receiving texts, or HELP for help.": "Responde STOP a cualquier mensaje de texto de Snappy para dejar de recibir mensajes, o HELP para obtener ayuda.",
  "Snappy Coin Laundry does not sell, rent, or share mobile phone numbers, SMS opt-in information, or SMS consent with third parties or affiliates for marketing or promotional purposes. We provide mobile information to service providers only as necessary to operate the service you requested — for example, to send messages, host the application, or process orders.": "Snappy Coin Laundry no vende, alquila ni comparte números de teléfono móvil, información de suscripción a SMS ni consentimiento para SMS con terceros o afiliados para fines de mercadeo o promoción. Proporcionamos información móvil a los proveedores de servicios solo cuando es necesario para prestar el servicio que solicitaste; por ejemplo, para enviar mensajes, alojar la aplicación o procesar pedidos.",
  "Email marketing consent is optional and must be selected separately. Marketing emails include an unsubscribe option.": "El consentimiento para mercadeo por correo es opcional y debe seleccionarse por separado. Los correos de mercadeo incluyen una opción para cancelar la suscripción.",
  "Snappy Coin Laundry does not sell, rent, or share mobile phone numbers, SMS opt-in information, or SMS consent with third parties or affiliates for marketing or promotional purposes. We provide mobile information to service providers only as necessary to operate the services you requested — for example, to send messages, host the website, or process orders. Those service providers may use the information only to provide those services to Snappy or as otherwise required by law.": "Snappy Coin Laundry no vende, alquila ni comparte números de teléfono móvil, información de suscripción a SMS ni consentimiento para SMS con terceros o afiliados para fines de mercadeo o promoción. Proporcionamos información móvil a los proveedores de servicios solo cuando es necesario para prestar los servicios que solicitaste; por ejemplo, para enviar mensajes, alojar el sitio web o procesar pedidos. Esos proveedores solo pueden usar la información para prestar esos servicios a Snappy o según lo exija la ley.",
  "Text messages": "Mensajes de texto",
  "Optional tips": "Propinas opcionales",
  "Tips are optional and are offered on your private order page when your order is out for delivery or delivered. No tip amount is selected automatically. You review and confirm the amount before it is charged separately to the card used for your order. Paid tips cannot be edited in the order page. Contact Snappy Coin Laundry if you have a question about a charge.": "Las propinas son opcionales y se ofrecen en la página privada de tu pedido cuando está en camino de entrega o entregado. No se selecciona ningún importe automáticamente. Revisas y confirmas el importe antes de que se cobre por separado a la tarjeta usada para tu pedido. Las propinas pagadas no se pueden editar en la página del pedido. Comunícate con Snappy Coin Laundry si tienes alguna pregunta sobre un cobro.",

  "Snappy Coin Laundry sends a one-time text code to verify that a mobile number belongs to the person placing an order. Operational updates about your order, including pickup confirmations, receipts, and delivery updates, are currently sent by email. We do not send marketing or promotional text messages.": "Snappy Coin Laundry envía un código de un solo uso por mensaje de texto para verificar que el número móvil pertenece a la persona que hace el pedido. Los avisos operativos sobre tu pedido, incluidas las confirmaciones de recogida, los recibos y las actualizaciones de entrega, se envían actualmente por correo electrónico. No enviamos mensajes de texto de mercadeo ni promocionales.",
  "Snappy Coin Laundry uses text messages only for verification: a one-time code to verify that a mobile number belongs to you. Operational updates about pickup-and-delivery orders are currently sent by email. Consent to receive a one-time verification text is separate from marketing consent, and we do not treat SMS verification consent as consent to receive SMS marketing. We do not send marketing or promotional text messages.": "Snappy Coin Laundry usa mensajes de texto solo para verificar tu número móvil mediante un código de un solo uso. Los avisos operativos sobre pedidos de recogida y entrega se envían actualmente por correo electrónico. El consentimiento para recibir un mensaje de verificación es distinto del consentimiento de mercadeo y no lo consideramos autorización para recibir mercadeo por SMS. No enviamos mensajes de texto de mercadeo ni promocionales.",
  "Message frequency varies with your verification requests. Each request normally sends one verification text; requesting another code sends an additional text. Message and data rates may apply according to your mobile carrier and plan.": "La frecuencia de los mensajes varía según tus solicitudes de verificación. Cada solicitud normalmente envía un mensaje de verificación; solicitar otro código envía un mensaje adicional. Pueden aplicarse cargos por mensajes y datos según tu operador móvil y tu plan.",
  "We text you a one-time code to verify your number. Order updates are currently sent by email. These are not marketing messages. Text message frequency varies with verification requests; message and data rates may apply. Reply STOP at any time to stop texts, or HELP for help.": "Te enviamos por mensaje de texto un código de un solo uso para verificar tu número. Los avisos del pedido se envían actualmente por correo electrónico. No son mensajes de mercadeo. La frecuencia de los mensajes de texto varía según las solicitudes de verificación; pueden aplicarse cargos por mensajes y datos. Responde STOP en cualquier momento para dejar de recibir mensajes, o HELP para obtener ayuda.",
  "Effective date: September 4, 2026": "Fecha de vigencia: 4 de septiembre de 2026",
  "Effective September 4, 2026": "Vigente desde el 4 de septiembre de 2026",
  ...
  "The tip payment was not completed and no tip was added. Check the saved payment method before trying again.": "El pago de la propina no se completó y no se agregó ninguna propina. Revisa el método de pago guardado antes de intentarlo de nuevo.",
...
const TEMPLATE_TRANSLATORS = Object.freeze([
  ...
  [/^(.+)\/lb · (.+) minimum\. Final total is based on actual weight after pickup\.$/, (_m, rate, minimum) => `${rate}/lb · mínimo de ${minimum}. El total final se calcula según el peso real después de la recogida.`],
  ...
  [/^This creates one final, separate tip payment for (.+)\. It cannot be changed or canceled online after it is paid\.$/, (_m, order) => `Esto crea un pago final y separado de propina para ${order}. Después de pagarse, no se puede cambiar ni cancelar en línea.`],
  [/^Thank you\. You added a (.+) tip to this order\.$/, (_m, amount) => `Gracias. Agregaste una propina de ${amount} a este pedido.`],
  ...
  [/^Minimum order charge: (.+)\.$/, (_m, value) => `Cargo mínimo del pedido: ${value}.`],
  [/^Verified until (.+)\.$/, (_m, value) => `Verificado hasta ${value}.`],

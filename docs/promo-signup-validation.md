...
- Meta ad attribution fields are sent when present, including `fbclid`, `meta_source`, `meta_placement`, Meta campaign/ad set/ad IDs, common Meta ad URL parameters, and `_fbp` / `_fbc` browser cookie values.

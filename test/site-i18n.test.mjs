...
const runtimeTemplateSamples = new Map([
  ...
  ["{value} bag{value} expected", ["1 bag expected", "2 bags expected"]],
  ...
  ["This creates one final, separate tip payment for {value}. It cannot be changed or canceled online after it is paid.", ["This creates one final, separate tip payment for PUD-20260715-AB12CD34. It cannot be changed or canceled online after it is paid."]],
  ["Thank you. You added a {value} tip to this order.", ["Thank you. You added a $5.00 tip to this order."]],
  ...
  ["Minimum order charge: {value}.", ["Minimum order charge: $35.00."]],
  ...
  ["Verified until {value}.", ["Verified until Jul 15, 2026, 9:30 AM."]],
